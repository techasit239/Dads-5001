...
Past 1 : ศึกษาตัวแปรที่มีความสัมพันธ์กับการเกิดอุบัติเหตุ ตัวแปรด้านมนุษย์ (Human factors) ตัวแปรด้านยานพาหนะ (Vehicle factors) ตัวแปรด้านสิ่งแวดล้อมและโครงสร้างพื้นฐาน (Environmental & Road factors) และ ตัวแปรด้านเวลาและบริบทสังคม (Temporal & Societal factors)

Past 2 : ประเมินความเสียหาย กำหนดพื้นที่และกลุ่มเป้าหมายที่ควรเฝ้าระวังเพื่อให้ ข้อเสนอเชิงนโยบายที่เหมาะสม

----------------------------------------------------------------------------------------------
## Past 1 : ศึกษาตัวแปรที่มีความสัมพันธ์กับการเกิดอุบัติเหตุ ##
...
-----------------------------------------------------------------------------------------
## Past 2 : ประเมินความเสียหาย กำหนดพื้นที่และกลุ่มเป้าหมายที่ควรเฝ้าระวังเพื่อให้ ข้อเสนอเชิงนโยบายที่เหมาะสมร ##
